...
def generate_email_summary_tool(client, config):
    ...
    def generate_email_summary(team: str) -> str:
        """Generate email summary from Jira data using Gemini AI."""
        try:
            # Input validation
            validated_team = validate_team_name(team)
            ...
            slack_data = {
                "team": validated_team,
                "channels": ["toolchain-release-readiness", "toolchain-general"],
...
def custom_ai_analysis_tool(client, config):
    ...
    def custom_ai_analysis(prompt: str, data: str = "") -> str:
        ...
        try:
            ...
            analysis_result = gemini_client.generate_content(prompt)
